...
const handleError = async () => {
  switch (role) {
    ...
    case "student":
      clearError({ redirect: '/student' })
      break

    case "teacher":
      clearError({ redirect: '/teacher/home' })
      break
    
    case "guest":
      clearError({ redirect: '/guest' })
      break
...
<template>
  <div class="w-full h-svh flex flex-col bg-background-blue-light justify-center items-center">
    <client-only>
      <Vue3Lottie
